...
from galog.app.ui.tag_filter_pane import TagFilteringMode, TagFilterPane
...
from galog.app.msgbox import msgBoxErr2, msgBoxPrompt
...
class TagFilterPaneController:
    ...
    def _handleButtonSaveClicked(self):
        ...
        if not filteringEnabled:
            ...
            if not msgBoxPrompt(title, caption, body):
                return
