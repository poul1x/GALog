...
class AXMLParser:
    ...
    def doNext(self):
        ...
        while 1:
            ...
            if (
                chunkType == tc.CHUNK_XML_START_NAMESPACE
                or chunkType == tc.CHUNK_XML_END_NAMESPACE
            ):
    ...
    def getName(self):
        if self.m_name == -1 or (
            self.m_event != tc.START_TAG and self.m_event != tc.END_TAG
        ):
            return ""
